namespace radiation_pattern
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
	        ...
	        this.nud_ampl.Minimum = new decimal(new int[] { 1, 0, 0, 65536 });
	        ...
	        this.nud_ampl.Value = new decimal(new int[] { 50, 0, 0, 0 });
	        ...
	        this.nud_m.Minimum = new decimal(new int[] { 2, 0, 0, 0 });
	        ...
	        this.nud_m.Value = new decimal(new int[] { 10, 0, 0, 0 });
	        ...
	        this.nud_k.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
	        this.nud_k.Location = new System.Drawing.Point(189, 157);
	        this.nud_k.Minimum = new decimal(new int[] { 1, 0, 0, 131072 });
	        ...
	        this.nud_k.Value = new decimal(new int[] { 5, 0, 0, 65536 });
	        ...
	        this.nud_wavelength.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
	        this.nud_wavelength.Location = new System.Drawing.Point(189, 130);
	        this.nud_wavelength.Minimum = new decimal(new int[] { 1, 0, 0, 65536 });
	        ...
	        this.nud_radius.Increment = new decimal(new int[] { 10, 0, 0, 0 });
	        this.nud_radius.Location = new System.Drawing.Point(189, 76);
	        this.nud_radius.Maximum = new decimal(new int[] { 1000, 0, 0, 0 });
	        this.nud_radius.Minimum = new decimal(new int[] { 10, 0, 0, 0 });
	        ...
	        this.nud_radius.Value = new decimal(new int[] { 100, 0, 0, 0 });
	        ...
	        this.nud_size.Increment = new decimal(new int[] { 10, 0, 0, 0 });
	        this.nud_size.Location = new System.Drawing.Point(189, 49);
	        this.nud_size.Maximum = new decimal(new int[] { 1000, 0, 0, 0 });
	        this.nud_size.Minimum = new decimal(new int[] { 50, 0, 0, 0 });
	        ...
	        this.nud_size.Value = new decimal(new int[] { 200, 0, 0, 0 });
	        ...
	        this.nud_n.Minimum = new decimal(new int[] { 2, 0, 0, 0 });
	        ...
	        this.nud_n.Value = new decimal(new int[] { 10, 0, 0, 0 });
